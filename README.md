...
A more advanced version of this system was developed as part of my research.  
It includes:
...
- Visual Studio 2022  
- .NET Framework 4.8  
- [OpenALPR SDK for .NET](https://github.com/openalpr/openalpr)

---

## 🖼️ Example

Example interface (minimal version):
